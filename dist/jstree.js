 ...
 */
	...
	$.jstree.defaults.contextmenu = {
         ...
         * Once a menu item is activated the `action` function will be invoked with an object containing the following keys:
         *
         * item - the contextmenu item definition as seen below,
         * reference - the DOM node that was used (the tree node),
         * element - the contextmenu DOM element,
		...
		items : function (o, cb) { // Could be an object directly
			return {
				"create" : {
                    ...
                    //"_disabled"		: true, //(this.check("create_node", data.reference, {}, "last")),
                    //"label"			: "Create",
					"label"				: "Verzeichnis Erstellen",
					"icon"				: "../../img/add_folder.png",
				...
				"remove" : {
					...
					"action"			: function (data) {
						var inst = $.jstree.reference(data.reference),
							obj = inst.get_node(data.reference);
/*
*   Modified at 14.07.2016 by AC
*/
                        if(obj.children.length > 0){
                            console.log("they have children cannot be deleted");
                            console.log(obj);
                ...
                /*
                *
                * @we will deactivate the Original CCP and hier we will activate the Upload and Download
                *
                */
				"ccp" : {
